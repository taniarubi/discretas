...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item[.] \; \inferrule{p \\ \\ \\ ↔ p \lor 0}
        {p \lor 0 \lor Q  \\ ↔ \\ p \lor Q}

        \item[b)] \; \inferrule{b \cdot c \\ \\ \\ =  y + w}
        {x + y + w \\ = \\ ?}
